(function() {
  ...
  ProjectRepository = (function(superClass) {
    ...
    function ProjectRepository() {
      ...
      this.addRelease = bind(this.addRelease, this);
      this.updateRelease = bind(this.updateRelease, this);      
    ...
    ProjectRepository.prototype.addRelease = function(projectId, tagName, releaseNotes, fn) {
      var params = {};
      params.description = releaseNotes;
      if (fn == null) {
        fn = null;
      }
      this.debug("Projects::addRelease()");
      return this.post("projects/" + (Utils.parseProjectId(projectId)) + "/repository/tags/" + (encodeURI(tagName)) + "/release", params, (function(_this) {
        return function(data) {
          if (fn) {
            return fn(data);
          }
    ...
    ProjectRepository.prototype.updateRelease = function(projectId, tagName, releaseNotes, fn) {
      var params = {};
      params.description = releaseNotes;
      if (fn == null) {
        fn = null;
      }
      this.debug("Projects::updateRelease()");
      return this.put("projects/" + (Utils.parseProjectId(projectId)) + "/repository/tags/" + (encodeURI(tagName)) + "/release", params, (function(_this) {
        return function(data) {
          if (fn) {
            return fn(data);
          }
